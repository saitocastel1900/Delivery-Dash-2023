...
namespace Manager.Stage
{
    public class StageGenerator : MonoBehaviour
    {
        ...
        {
            _middleOffset.x = _columnCount * StageObjectParametersConst.TileSize * 0.5f - StageObjectParametersConst.TileSize * 0.5f;
            _middleOffset.z = _rowCount * StageObjectParametersConst.TileSize * 0.5f - StageObjectParametersConst.TileSize * 0.5f;
        }
    }
}